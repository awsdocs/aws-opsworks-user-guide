...
**Note**  
On Linux stacks, you can get a complete list of these attributes, formatted as a JSON object, by using the agent CLI's get\_json command\. 
