...
If you have already completed any of the [Getting Started with AWS OpsWorks Stacks](gettingstarted_intro.md) walkthroughs, then you have met the prerequisites for this walkthrough, and you can skip ahead to [Step 2: Create a Simple Application Server Stack](gettingstarted-simple.md)\.
