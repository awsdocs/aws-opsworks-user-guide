...
**Topics**
+ [General Troubleshooting Tips](#w100ab1b9c52b7)
+ [Troubleshooting Specific Errors](#tshooterrors-chef)
+ [Additional help and support](#w100ab1b9c52c11)

## General Troubleshooting Tips<a name="w100ab1b9c52b7"></a>
...
**Topics**
+ [Managed node shows up in the Chef Automate dashboard in the Missing column](#w100ab1b9c52b9b4)
+ [Cannot create a Chef vault; `knife vault` command fails with errors](#w100ab1b9c52b9b6)
+ [Server creation fails with "requested configuration is currently not supported" message](#w100ab1b9c52b9b8)
+ [Chef server doesn't recognize organization names added in the Chef Automate dashboard](#w100ab1b9c52b9c10)
+ [Unable to create the server's Amazon EC2 instance](#w100ab1b9c52b9c12)
+ [Service role error prevents server creation](#w100ab1b9c52b9c14)
+ [Elastic IP address limit exceeded](#w100ab1b9c52b9c16)
+ [Cannot sign into the Chef Automate dashboard](#w100ab1b9c52b9c18)
+ [Unattended node association fails](#w100ab1b9c52b9c20)

### Managed node shows up in the Chef Automate dashboard in the Missing column<a name="w100ab1b9c52b9b4"></a>
...
### Cannot create a Chef vault; `knife vault` command fails with errors<a name="w100ab1b9c52b9b6"></a>
...
### Server creation fails with "requested configuration is currently not supported" message<a name="w100ab1b9c52b9b8"></a>
...
### Chef server doesn't recognize organization names added in the Chef Automate dashboard<a name="w100ab1b9c52b9c10"></a>
...
### Unable to create the server's Amazon EC2 instance<a name="w100ab1b9c52b9c12"></a>
...
### Service role error prevents server creation<a name="w100ab1b9c52b9c14"></a>
...
### Elastic IP address limit exceeded<a name="w100ab1b9c52b9c16"></a>
...
### Cannot sign into the Chef Automate dashboard<a name="w100ab1b9c52b9c18"></a>
...
### Unattended node association fails<a name="w100ab1b9c52b9c20"></a>
...
## Additional help and support<a name="w100ab1b9c52c11"></a>
