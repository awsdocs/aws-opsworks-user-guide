...
For alternative ways to pass data to your application, see [Passing Data to Applications](apps-data.md) and [Using an Amazon S3 Bucket](gettingstarted.walkthrough.photoapp.md)\.
