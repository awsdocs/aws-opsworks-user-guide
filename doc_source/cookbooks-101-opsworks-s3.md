...
Recipes can use the [AWS SDK for Ruby](http://docs.aws.amazon.com/sdk-for-ruby/v3/api/) to access most AWS services\. This topic shows how to use the SDK for Ruby to download a file from an S3 bucket\.

**Note**  
For more information about how to use the [AWS SDK for Ruby](http://docs.aws.amazon.com/sdk-for-ruby/v3/api/) to handle encryption and decryption, see [AWS::S3::S3Object](http://docs.aws.amazon.com/AWSRubySDK/latest/AWS/S3/S3Object.html)\.
